...
.log{margin-top:8px;border:1px dashed #bfcedf;border-radius:9px;padding:9px;background:#f8fbff;max-height:320px;overflow:auto;font-size:.77rem;font-family:"IBM Plex Mono","Consolas",monospace;white-space:pre-wrap}.region-opt-grid{display:grid;gap:8px;margin-top:10px}.region-opt-card{border:1px solid #d7e3ef;border-radius:10px;background:#fbfdff;padding:9px}.region-opt-head{display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:8px;font-size:.82rem;color:#2f4a68}.region-opt-head strong{font-size:.84rem;color:#1a3653}.region-opt-summary{margin-top:10px;border:1px solid #b8d2c3;background:#ecf8f1;border-radius:10px;padding:9px 10px;font-size:.84rem;color:#1d4f34;font-weight:610}.region-opt-span{border:1px solid #d4e1ee;border-radius:10px;background:#f9fcff;padding:8px}.region-opt-two{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.region-opt-region-weight{margin-top:6px}.hidden{display:none}
...
<button type="button" class="active" data-view="view-design">Configuracion</button>
<button type="button" data-view="view-import">Entrada del modelo</button>
...
<main class="main">
<header class="top"><span id="global-status" class="status">Esperando ejecucion</span></header>
