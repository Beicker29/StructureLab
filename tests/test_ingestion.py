...
class IngestionDomainTests(unittest.TestCase):
    ...
    def test_parse_span_layout_json_parses_is_deep_beam_aliases(self) -> None:
        raw = """
        [
          {
            "id": "S1",
        ...
        """
        parsed = parse_span_layout_json(raw)
        self.assertTrue(parsed[0]["is_deep_beam"])
        self.assertTrue(parsed[1]["is_deep_beam"])

    def test_parse_span_layout_json_defaults_is_deep_beam_false(self) -> None:
        raw = """
        [
          {
            "id": "S1",
        ...
        """
        parsed = parse_span_layout_json(raw)
        self.assertFalse(parsed[0]["is_deep_beam"])

    def test_parse_span_layout_json_rejects_invalid_is_deep_beam(self) -> None:
        raw = """
        [
          {
            "id": "S1",
